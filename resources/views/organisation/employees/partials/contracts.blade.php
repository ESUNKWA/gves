    ...
    <table class="min-w-full divide-y divide-line">
        <thead class="bg-surface-2">
            <tr>
                ...
                <th class="px-4 py-2 text-left text-xs font-medium text-muted uppercase tracking-wider">Salaire de base
                </th>
                    ...
                    <td class="px-4 py-3 text-right text-sm space-x-3">
                        ...
                        @can('employees.manage')
                            ...
                            <form method="POST"
                                ...
                                class="inline" onsubmit="return confirm('Supprimer ce contrat ?');">
                                @csrf
                                @method('DELETE')
