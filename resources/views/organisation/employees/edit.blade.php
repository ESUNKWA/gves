            ...
            <div>
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input name="birth_place" id="birth_place"
                            value="{{ old('birth_place', $employee->birth_place) }}" class="mt-1" />
                        <x-input-error :messages="$errors->get('birth_place')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="nationality" value="Nationalité" />
                        <x-country-select name="nationality" id="nationality" :selected="old('nationality', $employee->nationality)" class="mt-1" />
