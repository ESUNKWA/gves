<x-app-layout>
    <x-page-header :title="__('Nouvel employé')" :description="__('Créez le dossier d\'un nouvel employé.')" />

    <div class="max-w-4xl">
        <form method="POST" action="{{ route('organisation.employees.store') }}"
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input name="employee_number" id="employee_number"
                            value="{{ old('employee_number', $employee_number) }}" class="mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input name="birth_date" id="birth_date" value="{{ old('birth_date') }}" type="date"
                            class="mt-1" />
            ...
            <div>
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <x-text-input name="address" id="address" value="{{ old('address') }}" class="mt-1" />
                        <x-input-error :messages="$errors->get('address')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="city" value="Ville" />
                        <x-text-input name="city" id="city" value="{{ old('city') }}" class="mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input name="bank_account_number" id="bank_account_number"
                            value="{{ old('bank_account_number') }}" class="mt-1" />
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input name="social_security_number" id="social_security_number"
                            value="{{ old('social_security_number') }}" class="mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input name="category" id="category" value="{{ old('category') }}"
                            placeholder="ex : Cadre Classe 4.3" class="mt-1" />
                        <x-input-error :messages="$errors->get('category')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="qualification" value="Qualification" />
                        <x-text-input name="qualification" id="qualification" value="{{ old('qualification') }}"
                            class="mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input name="tax_shares" id="tax_shares" type="number" step="0.01"
                            min="0" value="{{ old('tax_shares') }}" class="mt-1" />
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input name="hire_date" id="hire_date"
                            value="{{ old('hire_date', now()->toDateString()) }}" type="date" class="mt-1" />
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-primary-button>{{ __('Créer l\'employé') }}</x-primary-button>
            </div>
        </form>
    </div>
</x-app-layout>
