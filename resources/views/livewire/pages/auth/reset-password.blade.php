...
<div>
    <h1 class="text-2xl font-semibold tracking-tight text-fg">{{ __('Réinitialiser le mot de passe') }}</h1>
    <p class="mt-1 text-sm text-muted">{{ __('Choisissez un nouveau mot de passe pour votre compte.') }}</p>
