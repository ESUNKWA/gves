...
<div>
    <h1 class="text-2xl font-semibold tracking-tight text-fg">{{ __('Espace personnel') }}</h1>
    <p class="mt-1 text-sm text-muted">{{ __('Accédez à votre pointage, vos congés, vos documents et votre paie.') }}</p>
    ...
    <p class="mt-6 text-center text-sm text-muted">
        {{ __('Vous êtes RH ou administrateur ?') }}
        <a href="{{ route('login') }}" wire:navigate class="font-medium text-brand hover:text-brand">
