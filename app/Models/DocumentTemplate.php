    ...
    public static function availableVariables(): array
    {
        return [
            'Employé' => [
                ...
                '{{employe.genre}}' => 'Genre',
                '{{employe.date_naissance}}' => 'Date de naissance',
                '{{employe.lieu_naissance}}' => 'Lieu de naissance',
                '{{employe.nationalite}}' => 'Nationalité',
                '{{employe.piece_identite}}' => "N° pièce d'identité",
                '{{employe.situation_familiale}}' => 'Situation familiale',
                '{{employe.email}}' => 'Email personnel',
                '{{employe.telephone}}' => 'Téléphone personnel',
                '{{employe.adresse}}' => 'Adresse',
                '{{employe.ville}}' => 'Ville',
                '{{employe.pays}}' => 'Pays',
                '{{employe.compte_bancaire}}' => 'Compte bancaire (IBAN/n° de compte)',
                '{{employe.numero_secu}}' => 'N° de sécurité sociale (CNPS, etc.)',
                '{{employe.categorie}}' => 'Catégorie professionnelle',
                '{{employe.qualification}}' => 'Qualification',
                '{{employe.parts_fiscales}}' => 'Parts fiscales',
                ...
                '{{employe.date_sortie}}' => 'Date de sortie',
