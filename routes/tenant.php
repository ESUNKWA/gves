...
|--------------------------------------------------------------------------
|
| Every route for the actual SIRH app — everything that used to live in
| routes/web.php before the multi-tenant split. routes/web.php now only
| holds the central/platform routes (landing page, tenant provisioning).
|
*/
